 ...
 * 
 */
package ikanalyzer.core;

import java.util.LinkedList;
import java.util.List;

import ikanalyzer.dic.Dictionary;
import ikanalyzer.dic.Hit;
...
class CJKSegmenter implements ISegmenter {
  ...
  /*
   * (non-Javadoc)
   * @see org.wltea.analyzer.ikanalyzer.core.ISegmenter#analyze(org.wltea.analyzer.ikanalyzer.core.AnalyzeContext)
   */
  ...
  /*
   * (non-Javadoc)
   * @see org.wltea.analyzer.ikanalyzer.core.ISegmenter#reset()
   */
  public void reset() {
    // 清空队列
    this.tmpHits.clear();
